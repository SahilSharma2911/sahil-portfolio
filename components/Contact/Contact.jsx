  ...
  return (
    <>
      ...
      <motion.section
        ...
        whileInView="animate"
      >
        <motion.div className="flex gap-4 lg:gap-8 flex-col lg:w-1/2">
          <motion.h2 className="text-4xl md:text-5xl lg:text-6xl font-bold">
            Send Message
          </motion.h2>
        ...
        <div className="flex flex-col w-full lg:w-1/2 relative">
          ...
          >
            <input
              ...
              required
              placeholder="Name"
              className="bg-transparent border border-white rounded-md px-3 py-2.5 md:py-3 outline-none w-full"
            />
            <input
              type="email"
              name="from_email"
